...
class Bertalign:
    def __init__(self,
        ...
        src = clean_text(src)
        tgt = clean_text(tgt)
        # Languages now provided as parameters - no detection needed
        ...
        src_lang_name = LANG.ISO[src_lang]
        tgt_lang_name = LANG.ISO[tgt_lang]
        
        # Store both code and name for API response
        self.src_lang = src_lang
        self.tgt_lang = tgt_lang
        self.src_lang_name = src_lang_name
        self.tgt_lang_name = tgt_lang_name
        
        # print("Source language: {}, Number of sentences: {}".format(src_lang_name, src_num))
        # print("Target language: {}, Number of sentences: {}".format(tgt_lang_name, tgt_num))
